...
<head>
    ...
    <title>andikaDwiyanto - Form Gaji Pegawai</title>
...
<body class="bg-dark text-light">
    ...
    <div class="container col-lg-12 mt-3 text-center">
        <h2><strong>FORM DATA PEGAWAI</strong></h2>
    </div>

    <div class="container col-lg-12 px-3 my-3" id="formContainer">
        <form method="POST">
            <div class="mb-3">
                <label class="form-label" for="namaPegawai">Nama Pegawai</label>
                <input class="form-control" name="namapegawai" id="namaPegawai" type="text" placeholder="masukkan nama.." data-sb-validations="required" />
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" value="Manager" id="manager" type="radio" name="jabatan" data-sb-validations="required" />
                    <label class="form-check-label" for="manager">Manager</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" value="Asisten" id="asistenManager" type="radio" name="jabatan" data-sb-validations="required" />
                    <label class="form-check-label" for="asistenManager">Asisten Manager</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" value="Kabag" id="kabag" type="radio" name="jabatan" data-sb-validations="required" />
                    <label class="form-check-label" for="kabag">Kepala Bagian</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" value="Staff" id="staff" type="radio" name="jabatan" data-sb-validations="required" />
            ...
            <div class="mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" value="Menikah" id="menikah" type="radio" name="status" data-sb-validations="required" />
                    <label class="form-check-label" for="menikah">Menikah</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" value="Belum Menikah" id="belumMenikah" type="radio" name="status" data-sb-validations="required" />
    ...
    if (isset($_POST['submit'])) {
        // Deklarasi variabel yang datanya diambil dari form input (name)
        ...
        // Switch case untuk menentukan gaji jabatan
        switch ($jabatan) {
            case 'Manager':
                $gajipokok = 20000000;
                break;
        ...
        // Deklarasi variabel tunjangan jabatan, dengan nilai 20 dikalikan dengan gaji pokok
        $tunjanganjabatan = 20 * $gajipokok / 100;

        // If-else untuk menentukan status
        ...
        // Total dari gaji kotor
        $gajikotor = $gajipokok + $tunjanganjabatan + $tunjangankeluarga;

        // Ternary dari zakat, jika pegawai beragama islam
